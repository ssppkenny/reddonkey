...
return [(function (){var pred__23230 = cljs.core.instance_QMARK_;
var expr__23231 = reactive_val;
if(cljs.core.truth_((pred__23230.cljs$core$IFn$_invoke$arity$2 ? pred__23230.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__23231) : pred__23230.call(null,reagent.ratom.RAtom,expr__23231)))){
return "ra";
} else {
if(cljs.core.truth_((pred__23230.cljs$core$IFn$_invoke$arity$2 ? pred__23230.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__23231) : pred__23230.call(null,reagent.ratom.RCursor,expr__23231)))){
return "rc";
} else {
if(cljs.core.truth_((pred__23230.cljs$core$IFn$_invoke$arity$2 ? pred__23230.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__23231) : pred__23230.call(null,reagent.ratom.Reaction,expr__23231)))){
return "rx";
} else {
if(cljs.core.truth_((pred__23230.cljs$core$IFn$_invoke$arity$2 ? pred__23230.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__23231) : pred__23230.call(null,reagent.ratom.Track,expr__23231)))){
return "tr";
} else {
return "other";
}
