...
var periods__$1 = cljs.core.vec((function (){var G__12658 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12657_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__12657_SHARP_,(0),(3));
}),G__12658);
} else {
return G__12658;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__12665){
var vec__12666 = p__12665;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12666,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12666,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__12669 = pattern;
switch (G__12669) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12669)].join('')));
...
return p1__12670_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__12671_SHARP_){
return p1__12671_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__12672_SHARP_){
return p1__12672_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__12673_SHARP_){
return p1__12673_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__12674_SHARP_){
return p1__12674_SHARP_.getHours();
});

break;
case "day":
return (function (p1__12675_SHARP_){
return p1__12675_SHARP_.getDate();
});

break;
case "month":
return (function (p1__12676_SHARP_){
return p1__12676_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__12677_SHARP_){
return p1__12677_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12678__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__12682){
var vec__12683 = p__12682;
var seq__12684 = cljs.core.seq(vec__12683);
var first__12685 = cljs.core.first(seq__12684);
var seq__12684__$1 = cljs.core.next(seq__12684);
var key = first__12685;
var args = seq__12684__$1;
var G__12686 = key;
...
break;
case "ordinal-suffix":
var vec__12687 = (function (){var G__12690 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__12690) : syntax_list.call(null,G__12690));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12686__$1)].join('')));
...
var d = value;
var G__12695 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__12696 = G__12695;
var seq__12697 = cljs.core.seq(vec__12696);
var first__12698 = cljs.core.first(seq__12697);
var seq__12697__$1 = cljs.core.next(seq__12697);
var unparser = first__12698;
var more = seq__12697__$1;
var s = "";
var d__$1 = d;
...
var seq__12706 = cljs.core.seq(vec__12705);
var first__12707 = cljs.core.first(seq__12706);
var seq__12706__$1 = cljs.core.next(seq__12706);
var unparser__$1 = first__12707;
var more__$1 = seq__12706__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__12708 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12708,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12708,(1),null);
var G__12744 = d__$3;
var G__12745 = more__$1;
var G__12746 = s__$3;
d__$1 = G__12744;
G__12695__$1 = G__12745;
s__$1 = G__12746;
continue;
}
break;
