...
return cljs.core.every_QMARK_((function (p__24352){
...
var ns_keyword = re_pressed.impl.__GT_ns_keyword(event_type);
return (function re_pressed$impl$__GT_set_key_BANG__$_set_key_BANG_(p__24368,p__24369){
var map__24370 = p__24368;
var map__24370__$1 = cljs.core.__destructure_map(map__24370);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24370__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__24371 = p__24369;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24371,(0),null);
var key_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24371,(1),null);
...
var ns_keyword = re_pressed.impl.__GT_ns_keyword(event_type);
return (function re_pressed$impl$__GT_clear_keys_BANG__$_clear_keys_BANG_(p__24379,p__24380){
var map__24381 = p__24379;
var map__24381__$1 = cljs.core.__destructure_map(map__24381);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24381__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__24382 = p__24380;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24382,(0),null);
var key_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24382,(1),null);
...
re_pressed.impl.prevent_default_keys_BANG_ = (function re_pressed$impl$prevent_default_keys_BANG_(_,p__24399){
var vec__24405 = p__24399;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24405,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24405,(1),null);
...
re_frame.core.reg_fx(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1([re_pressed.impl.ns_root,"keyboard-event"].join('')),(function (p__24424){
var map__24425 = p__24424;
var map__24425__$1 = cljs.core.__destructure_map(map__24425);
var event_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24425__$1,new cljs.core.Keyword(null,"event-type","event-type",319722813));
var arguments$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24425__$1,new cljs.core.Keyword(null,"arguments","arguments",-1182834456));
...
var map__24426 = arguments$;
var map__24426__$1 = cljs.core.__destructure_map(map__24426);
var clear_on_success_event_match = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24426__$1,new cljs.core.Keyword(null,"clear-on-success-event-match","clear-on-success-event-match",769810234));
...
var always_listen_QMARK_ = cljs.core.some((function (p1__24419_SHARP_){
return re_pressed.impl.is_key_QMARK_(hit_key,p1__24419_SHARP_);
}),always_listen_keys);
...
return cljs.core.every_QMARK_(cljs.core.true_QMARK_,cljs.core.mapv.cljs$core$IFn$_invoke$arity$3((function (p1__24420_SHARP_,p2__24421_SHARP_){
return re_pressed.impl.is_key_QMARK_(p1__24420_SHARP_,p2__24421_SHARP_);
...
var check_events = cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function re_pressed$impl$iter__24430(s__24431){
return (new cljs.core.LazySeq(null,(function (){
var s__24431__$1 = s__24431;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__24431__$1);
if(temp__5804__auto__){
var s__24431__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__24431__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__24431__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__24433 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__24432 = (0);
while(true){
if((i__24432 < size__5522__auto__)){
var vec__24434 = cljs.core._nth(c__5521__auto__,i__24432);
var seq__24435 = cljs.core.seq(vec__24434);
var first__24436 = cljs.core.first(seq__24435);
var seq__24435__$1 = cljs.core.next(seq__24435);
var trigger_event = first__24436;
var ks = seq__24435__$1;
cljs.core.chunk_append(b__24433,(function (){var triggered_QMARK_ = cljs.core.some(is_key_sequence_QMARK_,ks);
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[trigger_event,triggered_QMARK_],null));
})());

var G__24441 = (i__24432 + (1));
i__24432 = G__24441;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24433),re_pressed$impl$iter__24430(cljs.core.chunk_rest(s__24431__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24433),null);
}
} else {
var vec__24437 = cljs.core.first(s__24431__$2);
var seq__24438 = cljs.core.seq(vec__24437);
var first__24439 = cljs.core.first(seq__24438);
var seq__24438__$1 = cljs.core.next(seq__24438);
var trigger_event = first__24439;
var ks = seq__24438__$1;
return cljs.core.cons((function (){var triggered_QMARK_ = cljs.core.some(is_key_sequence_QMARK_,ks);
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[trigger_event,triggered_QMARK_],null));
})(),re_pressed$impl$iter__24430(cljs.core.rest(s__24431__$2)));
}
} else {
return null;
}
...
var vec__24427 = (function (){var G__24440 = check_events;
var G__24440__$1 = (((G__24440 == null))?null:cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__24422_SHARP_){
return cljs.core.second(p1__24422_SHARP_) === true;
}),G__24440));
if((G__24440__$1 == null)){
return null;
} else {
return cljs.core.first(G__24440__$1);
}
})();
var triggered_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24427,(0),null);
var event_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24427,(1),null);
var clear_QMARK_ = cljs.core.some(is_key_sequence_QMARK_,clear_keys);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("keydown",event_type)){
var prevent_default_keys_24442 = cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [ns_keyword("-prevent-default-keys")], null)));
var prevent_default_QMARK__24443 = cljs.core.some((function (p1__24423_SHARP_){
return re_pressed.impl.is_key_QMARK_(recent_key,p1__24423_SHARP_);
}),prevent_default_keys_24442);
if(cljs.core.truth_(prevent_default_QMARK__24443)){
