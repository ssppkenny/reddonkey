goog.provide('reddonkey.subs');
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("reddonkey.subs","name","reddonkey.subs/name",1351552413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db){
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("reddonkey.subs","re-pressed-example","reddonkey.subs/re-pressed-example",-1011523062),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,_){
return new cljs.core.Keyword(null,"re-pressed-example","re-pressed-example",1847120022).cljs$core$IFn$_invoke$arity$1(db);
})], 0));

//# sourceMappingURL=reddonkey.subs.js.map
