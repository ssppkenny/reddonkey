...
var G__12799 = devtools.prefs.pref(v);
v = G__12799;
continue;
} else {
return v;
...
}catch (e12765){var _e__11581__auto__ = e12765;
return false;
}})();
...
}catch (e12770){var _e__11581__auto__ = e12770;
return false;
}})();
...
}catch (e12773){var _e__11581__auto__ = e12773;
return false;
}}
}
});
...
var vec__12786 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12786,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12786,(1),null);
...
return cljs.core.some((function (p1__12791_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12791_SHARP_);
}),template);
});
