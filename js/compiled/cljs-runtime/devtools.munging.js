...
var o12437 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12437["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12438 = temp__5802__auto____$1;
return (o12438["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11554__auto__ = f;
return (o__11554__auto__["toString"]).call(o__11554__auto__);
} else {
return "";
}
}catch (e12444){var _ = e12444;
return "";
}});
...
try{var o__11554__auto___12741 = t;
(o__11554__auto___12741["cljs$lang$ctorPrWriter"]).call(o__11554__auto___12741,t,writer);
}catch (e12454){var __12742 = e12454;
}
...
var char_code = (function (){var o__11554__auto__ = (new String(char$));
return (o__11554__auto__["charCodeAt"]).call(o__11554__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11554__auto__ = String;
return (o__11554__auto__["fromCharCode"]).call(o__11554__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12473 = num_code;
switch (G__12473) {
case (1):
return (185);
...
var o__11554__auto__ = String;
return (o__11554__auto__["fromCharCode"]).call(o__11554__auto__,superscript_code);
});
/**
...
}catch (e12502){var _e__11581__auto__ = e12502;
return false;
}})())){
...
var vec__12512 = devtools.munging.parse_fn_source(fn_source);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12558){
var vec__12559 = p__12558;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12559,(0),null);
...
var G__12768 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12769 = cljs.core.butlast(remaining_tokens);
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12556){
var G__12557 = cljs.core.first(seq12556);
var seq12556__$1 = cljs.core.next(seq12556);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12557,seq12556__$1);
}));
...
var vec__12564 = cljs.core.split_with((function (p1__12563_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12563_SHARP_,"arity");
}),tokens);
...
var vec__12570 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12570,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12570,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12775 = cljs.core.rest(remaining_tokens);
var G__12776 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12775;
name_tokens = G__12776;
continue;
} else {
...
var vec__12580 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12580,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12580,(1),null);
var vec__12583 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12583,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12583,(1),null);
var vec__12586 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12586,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12586,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12586,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12586,(3),null);
...
var vec__12594 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12594,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12594,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12594,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12594,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12594,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12594,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12600 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12600,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12600,(1),null);
var vec__12603 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12603,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12603,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12609 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12609) : devtools.munging.parse_fn_info_deep.call(null,G__12609));
})()));
}
} else {
return fn_info;
...
var G__12789 = (arity + (1));
var G__12790 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12624){
var vec__12625 = p__12624;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12625,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12625,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12631_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12631_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12632_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12632_SHARP_);
}),sorted_infos);
...
var G__12800 = (i__5770__auto___12798 + (1));
i__5770__auto___12798 = G__12800;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12643){
var vec__12644 = p__12643;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12644,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12641){
var G__12642 = cljs.core.first(seq12641);
var seq12641__$1 = cljs.core.next(seq12641);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12642,seq12641__$1);
}));
...
var map__12667 = options;
var map__12667__$1 = cljs.core.__destructure_map(map__12667);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12667__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12667__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12667__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12667__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12668 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12668,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12668,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12668,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12668,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12668,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12668,(5),null);
...
var o__11554__auto__ = f;
return (o__11554__auto__["getBasis"]).call(o__11554__auto__);
});
/**
...
}catch (e12682){var _e__11581__auto__ = e12682;
...
var _STAR_ = (function (accum,p__12701){
var vec__12702 = p__12701;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12702,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12702,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12708){
var vec__12710 = p__12708;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12710,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12710,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12710,(2),null);
...
var post_process = (function (p__12730){
var vec__12731 = p__12730;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12731,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12731,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12724_SHARP_){
return (obj[cljs.core.first(p1__12724_SHARP_)]);
}),sorted_matches);
