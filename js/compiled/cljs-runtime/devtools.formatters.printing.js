...
var len__5769__auto___12868 = arguments.length;
var i__5770__auto___12869 = (0);
while(true){
if((i__5770__auto___12869 < len__5769__auto___12868)){
args__5775__auto__.push((arguments[i__5770__auto___12869]));

var G__12870 = (i__5770__auto___12869 + (1));
i__5770__auto___12869 = G__12870;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12802){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12803,G__12804,seq12802__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12820_SHARP_){
return (!((cljs.core.meta(p1__12820_SHARP_) == null)));
})))){
...
var map__12837 = opts;
var map__12837__$1 = cljs.core.__destructure_map(map__12837);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12837__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12838){var _e__11581__auto__ = e12838;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e12841){var _e__11581__auto__ = e12841;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12848 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12849 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12849);
...
var map__12851 = opts;
var map__12851__$1 = cljs.core.__destructure_map(map__12851);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12851__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12848);
}});
...
var temp__5802__auto___12925 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___12925)){
var managed_print_level_12926 = temp__5802__auto___12925;
var _STAR_print_level_STAR__orig_val__12859_12928 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12860_12929 = managed_print_level_12926;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12860_12929);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12856_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12856_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12859_12928);
}} else {
job_fn();
}
